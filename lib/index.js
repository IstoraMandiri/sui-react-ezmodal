  ...
  _createClass(EZModal, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          modalProps = _objectWithoutProperties(_props, ['data', 'trigger', 'header', 'content', 'actions', 'onClose', 'handleRemove', 'removeHeader', 'removeContent', 'handleSubmit', 'loading']);
      ...
      var defaultButtons = [_react2.default.createElement(_semanticUiReact.Button, { key: 'close', content: 'Cancel', onClick: hide }), _react2.default.createElement(_semanticUiReact.Button, { key: 'submit', positive: true, icon: 'checkmark', labelPosition: 'right', content: 'OK', onClick: handleThisSubmit })];
      if (handleRemove) {
