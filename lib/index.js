    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          actions ? this.renderCompOrFunc(actions, childProps) : [_react2.default.createElement(_semanticUiReact.Button, { key: 'close', icon: 'remove', content: 'Cancel', floated: 'left', onClick: hide }), _react2.default.createElement(_semanticUiReact.Button, { key: 'submit', icon: 'checkmark', content: 'OK', color: 'green', onClick: handleSubmit })]
        )
      );
    }
  }]);
