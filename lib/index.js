  ...
  _createClass(EZModal, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties(_props, ['data', 'trigger', 'header', 'content', 'actions', 'onClose', 'handleRemove', 'removeHeader', 'removeContent', 'noCloseButton', 'noSubmitButton', 'closeButtonText', 'submitButtonText', 'handleSubmit', 'loading', 'error', 'errorHeader', 'initiallyOpen']);
