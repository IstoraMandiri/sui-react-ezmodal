  ...
  _createClass(EZModal, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (this.props.handleSubmit) {
        this.handlePromiseOrFunc(this.props.handleSubmit(this.state.formData)).then(function (res) {
          if (res !== false) {
    ...
    value: function render() {
      var _props = this.props,
          ...
          modalProps = _objectWithoutProperties(_props, ['data', 'trigger', 'header', 'content', 'actions', 'onClose', 'handleRemove', 'removeHeader', 'removeContent']);
      ...
      return _react2.default.createElement(
        ...
        _extends({}, modalProps, {
          ...
          onClose: function onClose() {
            handleShowToggle(false);_onClose && _onClose();
          }
        }),
