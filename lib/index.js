  ...
  _createClass(EZModal, [{
    ...
    value: function handleHide() {
      ...
      if (this.props.onClose) {
        return this.handlePromiseOrFunc(this.props.onClose(this.state.formData)).then(function (res) {
          if (res !== false) {
            _this3.handleShowToggle(false);
          }
        });
      }
    ...
    value: function render() {
      ...
      var headerText = typeof header === 'function' ? header(childProps) : header;
      ...
      var activeErrorText = activeError && (activeError.message || activeError.error && activeError.error.message || activeError.error || activeError);
...
EZModal.propTypes = {
  ...
  errorHeader: _propTypes2.default.string,
  ...
  actions: _propTypes2.default.oneOfType([_propTypes2.default.node, _propTypes2.default.func, _propTypes2.default.bool]),
  handleSubmit: _propTypes2.default.func,
  handleRemove: _propTypes2.default.func,
  removeHeader: _propTypes2.default.string,
  removeContent: _propTypes2.default.oneOfType([_propTypes2.default.node, _propTypes2.default.func]),
  noCloseButton: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func]),
  noSubmitButton: _propTypes2.default.oneOfType([_propTypes2.default.bool, _propTypes2.default.func]),
  closeButtonText: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.func]),
  submitButtonText: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.func]),
  disableHiddenSubmitButton: _propTypes2.default.bool
};