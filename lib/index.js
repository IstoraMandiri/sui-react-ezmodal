  ...
  _createClass(EZModal, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties(_props, ['data', 'trigger', 'header', 'content', 'actions', 'handleRemove', 'removeHeader', 'removeContent', 'noCloseButton', 'noSubmitButton', 'closeButtonText', 'submitButtonText', 'handleSubmit', 'loading', 'error', 'errorHeader', 'initiallyOpen', 'onClose']);
      ...
      var defaultButtons = [!notShowingClosed && _react2.default.createElement(_semanticUiReact.Button, { key: 'close', content: closeButtonContent || 'Cancel', onClick: hide }), !notShowingSubmit && _react2.default.createElement(_semanticUiReact.Button, { type: 'submit', key: 'submit', positive: true, icon: 'checkmark', labelPosition: 'right', content: submitButtonContent || 'OK', onClick: handleThisSubmit })];
